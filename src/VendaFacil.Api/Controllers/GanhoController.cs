...
namespace VendaFacil.Api.Controllers
{
    ...
    public class GanhoController : ControllerBase
    {
        ...
        private int ObterTotalPaginas(filtroGanhoViewModel filtro)
        {
        ...
        #region [Contrutor]
        public GanhoController(IMapper mapper)
        {
            _mapper = mapper;
            _service = new GanhoService(new BaseRepository(), _mapper);
        }
        #endregion
        ...
        [HttpPost("ObterTodos")]
        public IActionResult PostObterTodos([FromBody] filtroGanhoViewModel filtro)
        {
            List<GanhoViewModel> dadosRetorno = _service.ObterTodos(filtro).ToList();
        ...
        [HttpPost("Inserir")]
        public IActionResult PostInserir([FromBody] GanhoViewModel model)
        {
        ...
        [HttpPut("Atualizar")]
        public IActionResult PutAtualizar([FromBody] GanhoViewModel model)
        {
            if (ModelState.IsValid)
            {
