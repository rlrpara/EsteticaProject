...
namespace Estetica.Tests.PesentationTests.ControllersTests.EmpresaControllerTests
{
    public class EmpresaControllerBaseTests
    {
        ...
        public async Task<IEnumerable<EmpresaViewModel>> ObterEmpresas() => new List<EmpresaViewModel>
        {
